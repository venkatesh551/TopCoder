...
// CUT begin
	public static void main(String[] args){
		System.err.println("ProblemSetsEasy (500 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
	    ...
	    while (true) {
            ...
            int EM = Integer.parseInt(Reader.nextLine());
            int M = Integer.parseInt(Reader.nextLine());
            int MH = Integer.parseInt(Reader.nextLine());
	...
	static class Reader {
        private static final String dataFileName = "ProblemSetsEasy.sample";
